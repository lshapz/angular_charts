...
var BarChartComponent = /** @class */ (function () {
    ...
    function (data, id, yaxisvalue, xaxisvalue, mouseover_callback) {
        ...
        var tooltip = select("body")
            ...
            .style("opacity", 0);
        /** @type {?} */
        var chart = select(selection_string)
            .append("svg")
...
var BubbleChartComponent = /** @class */ (function () {
    ...
    function (data) {
        ...
        /** @type {?} */
        var formatDate = timeParse(this.dateFormat);
        /** @type {?} */
        var xScale;
        if (this.isDate) {
        ...
        var yAxis = axisLeft()
            ...
            .ticks(4);
        /** @type {?} */
        var max_value_size = Math.sqrt(max(data, (/**
         * @param {?} d
         * @return {?}
         */
        function (d) {
        ...
        /** @type {?} */
        var zScale = scaleLinear().domain([1, max_value_size]).range([
            min_bubble_size,
            max_bubble_size
        ]);
        /** @type {?} */
        ...
        /** @type {?} */
        var valMin = min(data, zValue);
        /** @type {?} */
        var valMax = max(data, zValue);
        /** @type {?} */
        var color = scaleQuantize().range(colors).domain([valMin, valMax]);
        /** @type {?} */
        var tooltip = select("body")
            .append("div")
            .attr("class", "d3_visuals_tooltip " + this.propID + "_tooltip")
        ...
        /** @type {?} */
        var xMin = min(data, xValue);
        /** @type {?} */
        var xMax = max(data, xValue);
        /** @type {?} */
        var yMin = min(data, yValue);
        /** @type {?} */
        var yMax = max(data, yValue);
        // Determine padding for x-axis if it's dates.
        if (this.isDate) {
            /** @type {?} */
            var min$$1 = xScale(xMin);
            /** @type {?} */
            var max$$1 = xScale(xMax);
        ...
        function (d) {
            /** @type {?} */
            var tooltip = select("." + localThis.propID + "_tooltip");
...
var LinePlotComponent = /** @class */ (function () {
    ...
    function (dataArray, selection_string, color) {
        ...
        /** @type {?} */
        var xScale = scaleTime().range([0, width - margin.right]);
        /** @type {?} */
        var xMap = (/**
         * @param {?} d
         * @return {?}
        ...
        // debugger
        /** @type {?} */
        var svg = select(selection_string)
            .append("svg")
            .attr("width", width + margin.left + margin.right)
            .attr("height", height + margin.top + margin.bottom)
            .append("g")
...
var SunburstComponent = /** @class */ (function () {
    ...
    function () {
        ...
        /** @type {?} */
        var svg = select(selection_string).append("svg")
            .attr("width", width)
            .attr("height", height)
            .append("g")
            .attr("transform", "translate(" + width / 2 + "," + (height / 2) + ")");
        ...
        var tooltip = select("body")
            ...
            .style("opacity", 0);
        /** @type {?} */
        var root = hierarchy(this.data[0]);
        root.sum((/**
         * @param {?} d
         * @return {?}
         */
        ...
        function click(d) {
            ...
            function () {
                ...
                /** @type {?} */
                var yd = interpolate(y.domain(), [d.y0, 1]);
                /** @type {?} */
                var yr = interpolate(y.range(), [d.y0 ? 20 : 0, radius]);
                return (/**
                 * @param {?} t
                 * @return {?}
                 */
